...
<div class="builder-ui-display-row-wrapper">
  ...
  <?php if (!empty($columns)): ?>
    <div data-bid="<?php print $builder->cache_id; ?>" data-rid="<?php print $row_id; ?>" class="builder-ui-column-items-wrapper builder-ui-row">
      <?php
      ...
      foreach ($columns as $column):
        ...
        ?>
        <div data-cid="<?php print $column_id; ?>" class="builder-ui-column <?php print builder_column_css($column); ?> builder-ui-column-item-<?php print $column_id; ?>">
            ...
            <div class="builder-ui-column-inside">
              ...
              <div class="builder-ui-column-title-wrapper builder-draggable">
                <?php if (!empty($column['settings']['title'])): ?>
                  <h2 class="builder-ui-column-title"><?php print filter_xss_admin($column['settings']['title']); ?></h2>
                <?php else: ?>
                  <h2 class="builder-ui-column-no-title"><?php print t('No title'); ?></h2>
                <?php endif; ?>
              </div>
              <!-- // column title -->
              ...
              <!--- contents wrapper-->
              <div data-bid="<?php print $builder->cache_id; ?>" data-rid="<?php print $row_id; ?>" data-cid="<?php print $column_id; ?>" class="builder-ui-contents-wrapper">
                ...
                <?php if (!empty($sorted_contents)): ?>
                  ...
                  <?php foreach ($sorted_contents as $content): ?>
                    ...
                    ?>
                    <div data-contentid="<?php print $content_id; ?>" class="builder-ui-content-wrapper">
                      <div class="builder-ui-content-inner">
                        <!-- content title -->
                        <div class="builder-ui-content-title-wrapper builder-draggable">
                          <div class="builder-ui-action-links builder-ui-content-title-buttons">
                            <?php print $content_actions[$row_id][$column_id][$content_id] ?>
                          </div>
                          <span class="builder-ui-content-title-text"><?php print !empty($content['title']) ? filter_xss_admin($content['title']) : filter_xss_admin($content['info']); ?></span>
                        </div>
                        <!-- // content title -->
                        ...
                        <div class="builder-ui-content-render-wrapper">
                          <div class="builder-ui-content-render-inner">
                            ...
                            if (isset($build_content)) {
                              ...
                              print theme('ctools_collapsible', array('collapsed' => TRUE, 'handle' => filter_xss_admin($content['info']), 'content' => $collapsible_content));
                            }
                            ?>
                          </div>
                        </div>
